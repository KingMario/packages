...
import { NgxLowerCaseDirective } from '../lib';

@Component({
  template: `
    <textarea #input1 [(ngModel)]="value" lowerCase></textarea>
    <div [formGroup]="formA">
      <textarea #input2 formControlName="fieldA" lowerCase="blur"></textarea>
    </div>
    <div [formGroup]="formB">
      <textarea #input3 formControlName="fieldB" lowerCase="blur"></textarea>
      <textarea #input4 formControlName="fieldC" lowerCase></textarea>
    </div>
  `,
})
class TestComponent {
